...
open class GeminiCliHarness protected constructor(bridge: SdkBridge, scope: CoroutineScope, namespace: StorageNamespace?) :
    ...
    override val support = SupportReport(mapOf(
        ...
        Capability.CONTEXT_RETENTION to Support.Unsupported("The SDK does not expose provider retention control"),
        Capability.USER_HISTORY_VISIBILITY to Support.Unsupported("The SDK does not expose user-history visibility control"),
