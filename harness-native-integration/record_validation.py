...
sources = {}
for module in ("harness-protocol", "harness-runtime", "harness-process-bridge", "harness-codex", "harness-gemini-cli", "harness-koog", "harness-conformance", "harness-native-integration"):
    for path in sorted((repo / module / "src").rglob("*.kt")):
...
target = repo / "harness-native-integration/evidence" / (args.stage + ".json")
